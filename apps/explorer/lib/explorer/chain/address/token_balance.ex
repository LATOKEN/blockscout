defmodule Explorer.Chain.Address.TokenBalance do
   ...
   *  `token_id` - The token_id of the transferred token (applicable for LARC-1155 and LARC-721 tokens)
  ...
  ignores the burn_address for tokens LARC-721 since the most tokens LARC-721 don't allow get the
  ...
  def unfetched_token_balances do
    from(
      ...
      where:
        ((tb.address_hash != ^@burn_address_hash and t.type != "LARC-721") or t.type == "LARC-20" or t.type == "LARC-1155") and
