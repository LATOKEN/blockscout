defmodule Explorer.Chain.TokenTransfer do
  ...
  * `:token_id` - ID of the token (applicable to LARC-721 tokens)
  ...
  * `:amounts` - Tokens transferred amounts in case of batched transfer in LARC-1155
  * `:token_ids` - IDs of the tokens (applicable to LARC-1155 tokens)
  """
  ...
  @larc1155_single_transfer_signature "0xc3d58168c5ae7397731d063d5bbf3d657854427343f4c083240f7aacaa2d0f62"
  @larc1155_batch_transfer_signature "0x4a39dc06d4c0dbc64b70af90fd698a233a518aa5d07e595d983b8c0526c8f7fb"
  ...
  def larc1155_single_transfer_signature, do: @larc1155_single_transfer_signature

  def larc1155_batch_transfer_signature, do: @larc1155_batch_transfer_signature
  ...
  A token LARC-721 is considered unique because it corresponds to the possession
  of a specific asset.
