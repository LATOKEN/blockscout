defmodule Explorer.Chain.Import.Runner.Address.CurrentTokenBalancesTest do
  ...
  describe "run/2" do
    ...
    test "inserts values for multiple token IDs in the current token balances", %{
      ...
      token_larc_20 = insert(:token, holder_count: 0)
      token_larc_20_contract_address_hash = token_larc_20.contract_address_hash
      value_3 = Decimal.new(333)
      token_id_3 = nil

      token_larc_721 = insert(:token, holder_count: 0)
      token_larc_721_contract_address_hash = token_larc_721.contract_address_hash
              ...
              %{
                address_current_token_balances: [
                  %Explorer.Chain.Address.CurrentTokenBalance{
                    address_hash: ^address_hash,
                    block_number: ^block_number,
                    token_contract_address_hash: ^token_larc_20_contract_address_hash,
                    value: ^value_3,
                    token_id: ^token_id_3
                  },
                  %Explorer.Chain.Address.CurrentTokenBalance{
                    address_hash: ^address_hash,
                    block_number: ^block_number,
                    token_contract_address_hash: ^token_larc_721_contract_address_hash,
                    value: ^value_5,
                    token_id: nil
                  },
                  %Explorer.Chain.Address.CurrentTokenBalance{
                ...
                address_current_token_balances_update_token_holder_counts: [
                  ...
                  %{
                    contract_address_hash: ^token_larc_20_contract_address_hash,
                    holder_count: 1
                  },
                  %{
                    contract_address_hash: ^token_larc_721_contract_address_hash,
                    holder_count: 1
                  }
                ]
              }} =
               run_changes_list(
                 [
                   ...
                   %{
                     address_hash: address_hash,
                     block_number: block_number,
                     token_contract_address_hash: token_larc_20.contract_address_hash,
                     value: value_3,
                     value_fetched_at: DateTime.utc_now(),
                     token_id: token_id_3,
                     token_type: "LARC-20"
                   ...
                   %{
                     address_hash: address_hash,
                     block_number: block_number,
                     token_contract_address_hash: token_larc_721.contract_address_hash,
                     value: value_4,
                     value_fetched_at: DateTime.utc_now(),
                     token_id: token_id_4,
                     token_type: "LARC-721"
