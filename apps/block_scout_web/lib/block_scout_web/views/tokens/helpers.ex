defmodule BlockScoutWeb.Tokens.Helpers do
  ...
  defp do_token_transfer_amount(%Token{type: "LARC-20"}, nil, nil, _token_id, _token_ids) do
    {:ok, "--"}
  end

  defp do_token_transfer_amount(%Token{type: "LARC-20", decimals: nil}, amount, _amounts, _token_id, _token_ids) do
    {:ok, CurrencyHelpers.format_according_to_decimals(amount, Decimal.new(0))}
  end

  defp do_token_transfer_amount(%Token{type: "LARC-20", decimals: decimals}, amount, _amounts, _token_id, _token_ids) do
